...
import { Item, itemFormSchema, ItemFormValues, PurchaseOrderFormProps, PurchaseOrderFormValues, purchaseOrderSchema, purchaseOrderStatuses, Supplier, Product } from '../interface/interface';
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectTrigger, SelectValue } from '../ui/select';
import { getSuppliers } from '@/app/actions/supplier';
import { getProducts } from '@/app/actions/product';
import { Trash2, Plus } from 'lucide-react';

export function PurchaseForm({ defaultValues, onSubmit, submitLabel = "Save" }: PurchaseOrderFormProps) {
                    ...
                    <div className="col-span-full space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Button
                                ...
                                variant="outline"
                                size="sm"
                                onClick={() => append({ id: "", productName: "", slug: "", quantity: 1, unitCost: 0, subTotal: 0, currentStock: 0 })}
                            >
                        ...
                        <div className="space-y-4">
                            {fields.map((field, index) => (
                                <div key={field.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end border p-4 rounded-md bg-slate-900/50">
